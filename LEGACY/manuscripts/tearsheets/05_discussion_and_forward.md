...
> **Tearsheet** for [`notebooks/05_discussion_and_forward.py`](../../notebooks/05_discussion_and_forward.py) · [HTML report](../../site/05_discussion_and_forward.html) · last run `2026-04-19T07:43:07+00:00`
...
**Summary findings + headline numbers**

| field | value |
| --- | --- |
| `headline` | 4,717,140 New Yorkers (55.4% of the study population) live in tracts with no … |
| `queens_gap_population` | `1752073` |
...
*Auto-generated by `jellycell export tearsheet notebooks/05_discussion_and_forward.py`. Regenerating overwrites this file — for hand-authored writeups put a `.md` at the root of `manuscripts/` instead of under `tearsheets/`.*
