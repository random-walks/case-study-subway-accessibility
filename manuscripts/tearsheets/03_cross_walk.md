...
> **Tearsheet** for [`notebooks/03_cross_walk.py`](../../notebooks/03_cross_walk.py) · [HTML report](../../site/03_cross_walk.html) · last run `2026-04-20T16:21:36+00:00`
...
**Cross-walk: 18 rows mapping subway-access CASESTUDY sections to factor-factory engine families and blaise-website portfolio topics.**
